...
public class Catalina {
    ...
    public void load() {
        ...
        initNaming();   //todo jndi

        // Create and execute our Digester
        Digester digester = createStartDigester(); //todo
        ...
        try {
            getServer().init(); //todo StandardServerStandardServiceStandardEngineListenerStandardThreadExecutorConnectorProtocolHandler
        } catch (LifecycleException e) {
